...
public class BackGroundVerifierController
{
	...
	public LoginDto authentication(@PathVariable ("enter-userid") int id,@PathVariable("password") String pass ,@PathVariable("role-id") int roleid) throws InvalidDetailsException
	{
